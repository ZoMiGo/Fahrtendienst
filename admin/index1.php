...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Fahrten</b>Dienst</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <?php $pic = $_SESSION["name"] ; ?>
              <img src="profile_pics/<?php echo $pic ?>.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION["name"] ;?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="profile_pics/<?php echo $pic ?>.png" class="img-circle" alt="User Image">

                <p>
                  <?php echo $_SESSION["name"] ;?>
                  <small>Disponent</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="pdf.php?id=<?= $_SESSION["user_id"]; ?>">PDF Download</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="user_mail.php?id=<?= $_SESSION["user_id"]; ?>">PDF to Email</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="worktime.php?id=<?= $_SESSION["email"]; ?>">Stundenliste</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="view_driver.php?m=update&cid=<?= $_SESSION["user_id"]; ?>" target="loader" class="btn btn-default btn-flat">Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span><?php echo $access["top_menu_name"];?></span>
           ...
           <?php
                        ...
                        foreach ($access as $k => $val) {
                            if ($k != "top_menu_name") {
                                echo '<li><a href="' . ($val["page_name"]) . '"target="loader">' . $val["menu_name"] . '</a></li>';
                                ?>
                                <?php
                            }
                        }
...
<iframe  src='dashboard.php' style="height:1040px; width:100%; border:0px" name="loader" scrolling="yes"></iframe>
