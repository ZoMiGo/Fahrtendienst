  ...
  <div class="container-fluid" id="pcont">
    ...
    <div class="cl-mcont">
	  <div class="row">
        ...
        <form class="form-horizontal" name="freizeit_process_form" id="freizeit_process_form" enctype="multipart/form-data" method="post" action="freizeit_process_form.php">
	    ...
	    <div class="form-group col-md-3 setmyheight">
	      ...
	      <div class="form-group col-md-3 setmyheight">
            ...
            <textarea class="form-control" rows="3" name="zinfo" value="<?php echo $results[0]["zinfo"] ?>" placeholder="Enter ..."></textarea>
			  ...
			  <input type="text" name="fsw" value="<?php echo $results[0]["fsw"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
              <div class="form-group col-md-3 setmyheight">
...
<div class="form-group col-md-3 setmyheight">
			  ...
			  <input type="text" name="SvNr" value="<?php echo $results[0]["SvNr"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
              <div class="form-group col-md-4 setmyheight">
...
<div class="form-group col-md-3 setmyheight">
			  ...
			  <input type="text" name="kdnr" value="<?php echo $results[0]["kdnr"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
...
<input type="hidden" id="longitude" name="longitude" value="<?php echo $results[0]["longitude"] ?>"/>  
		<div class="form-group col-md-3 setmyheight">
			  ...
			  <input type="text" name="termin" value="<?php echo $results[0]["termin"] ?>" parsley-trigger="change"  placeholder="08:00" placeholder="" class="form-control">
            </div>
