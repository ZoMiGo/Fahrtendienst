...
url         = "user_dauerauftregenew.php?frm_action=3&cid=" +iCustomerId;
...
<?php } ?>
        ...
        <form class="form-horizontal" name="user_dauerauftregenew" id="user_dauerauftregenew_form" enctype="multipart/form-data" method="post" action="user_dauerauftregenew_process_form.php">
