  ...
  <div class="container-fluid" id="pcont">
    ...
    <div class="cl-mcont">
	  <div class="row">
		...
		<input type="text" readonly="" id="phone" name="phone" value="<?php echo $results[0]["phone"] ?>" parsley-trigger="change"   placeholder="" class="form-control">			
            </div>
              <div class="form-group col-md-3 setmyheight">
              <label>FSW Nr:.</label>
		<input type="text" readonly="" name="fsw" value="<?php echo $results[0]["fsw"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
              <div class="form-group col-md-3 setmyheight">
              <label>FSW G&uuml;ltig bis:.</label>
		<input type="text" readonly="" name="fsw" value="<?php echo $results[0]["mobilitet"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
		...
		<input type="text" readonly="" name="kassa" value="<?php echo $results[0]["kassa"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            ...
            <div class="form-group col-md-3 setmyheight">
              <label>SVNr:.</label>
		<input type="text" readonly="" name="SvNr" value="<?php echo $results[0]["SvNr"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
             </div>
	     <div class="form-group col-md-3 setmyheight">
	    ...
	    <div class="form-group col-md-3 setmyheight">
			...
			<div class="form-group col-md-3 setmyheight">
			  ...
			  <input type="text" name="phoneF" readonly="" value="<?php echo $results[0]["phoneF"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
			<div class="form-group col-md-3 setmyheight">
              <label>Telefon Mutter</label>
			  <input type="text" name="phoneM" readonly="" value="<?php echo $results[0]["phoneM"] ?>" parsley-trigger="change"   placeholder="" class="form-control">
            </div>
            <div class="form-group col-md-3 setmyheight">
