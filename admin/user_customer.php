...
include './header.php';
try {
   $sql = "SELECT * FROM userkunden WHERE 1 AND user_id = :cid";
   $stmt = $DB->prepare($sql);
  ...
  <div class="container-fluid" id="pcont">
    ...
    <div class="cl-mcont">
	  <div class="row">
        ...
        <form class="form-horizontal" name="user_customer_process_form" id="user_customer_process_form" enctype="multipart/form-data" method="post" action="user_customer_process_form.php">
