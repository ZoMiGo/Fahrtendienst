...
try {
  ...
  if ($keyword <> "" ) {
    ...
    //$sql = "SELECT * FROM texirequest WHERE dauer_auftrag = 1 ";
    $sql = "SELECT * FROM texirequest WHERE 1 ORDER BY driver_name, termin";
...
<?php } ?>
    ...
    <div class="panel-body">
      ...
      <div class="col-lg-12" style="padding-left: 0; padding-right: 0;" >
        ...
        <div class="pull-right" ><a href="dauerauftrege.php"><button class="btn btn-success"><span class="glyphicon glyphicon-user"></span> Auftrag Hinzuf&#252;gen</button></a></div>
              <?php } ?>
</div>
...
//********************************************************************************************
//$a = $res["location"]; $ret = explode('@', $a); echo $ret[0]; // Citai Resultat ispred "@"
//********************************************************************************************
  ...
  ?>
               ...
               <?php $pic = ($res["accept"] <> "" ) ? $res["accept"] : "no.png" ?>
                  ...
                  <td>
                    ...
                    <a href="dauerauftrege.php?m=update&cid=<?php echo $res["id"]; ?>&pagenum=<?php echo $_GET["pagenum"]; ?>"><button class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</button></a>&nbsp;
                    <?php } ?>
