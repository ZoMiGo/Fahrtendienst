...
if ($mode == "add_new" ) {
  ...
  $at ="@";
  $tick = ",";
  $droplocation1 = trim($_POST['droplocation']);
  $location1 = trim($_POST['location']);  
  $latitude = trim($_POST['latitude']);
  $longitude = trim($_POST['longitude']);
  $ank_latitude = trim($_POST['ank_latitude']);
  $ank_longitude = trim($_POST['ank_longitude']);
  $droplocation = "$droplocation1$at$latitude$tick$longitude";
  $location ="$location1$at$ank_latitude$tick$ank_longitude";
  ...
  $auftrag_typ = trim($_POST['auftrag_typ']); //"texirequest"; // Vorbereitung für Auftrag Art
  ...
  if (!$error) {
    $sql = "INSERT INTO `$auftrag_typ` (`driver_id`, `driver_email`, `driver_name`, `sender_id`, `name`, `typ`, `sbehalt`, `Transportar`, `bfahrer`, `zinfo`, `dauer_auftrag`, `status`, `phoneM`, `phoneF`, `termin`, `phone`, `droplocation`, `location`, `latitude`, `longitude`, `ank_latitude`, `ank_longitude`, `timedate`, `disponent`, `accept`) 
VALUES ". "(:driverid, :driveremail, :drivername, :senderid, :name, :typ, :sbehalt, :Transportar, :bfahrer, :zinfo, :dauerauftrag, :status :auftrag_typ, :phoneM, :phoneF, :termin, :phone, :droplocation, :location, :latitude, :longitude, :ank_latitude, :ank_longitude, :timedate, :disponent, :accept)";
    try {
      $stmt = $DB->prepare($sql);
      ...
      $stmt->bindValue(":ank_latitude", $ank_latitude);    // sende cordinaten zur adresse
      $stmt->bindValue(":ank_longitude", $ank_longitude);  // sende cordinaten zur adresse
  ...
  header("location:all_dauerauftrege.php");
  ...
  header("location:all_dauerauftrege.php?pagenum=".$_POST['pagenum']);
} elseif ( $mode == "delete" ) {
   $cid = intval($_GET['cid']);
   ...
   header("location:all_dauerauftrege.php?pagenum=".$_GET['pagenum']);
}
