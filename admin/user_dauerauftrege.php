...
$status = FALSE;
if ( authorize($_SESSION["access"]["Alle Dauer Auftrege"]["Dispo"]["create"]) ||
     authorize($_SESSION["access"]["Alle Dauer Auftrege"]["Dispo"]["edit"]) ||
     authorize($_SESSION["access"]["Alle Dauer Auftrege"]["Dispo"]["view"]) ||
     authorize($_SESSION["access"]["Alle Dauer Auftrege"]["Dispo"]["delete"]) ) {
     $status = TRUE;
}
...
<?php } ?>
        ...
        <form class="form-horizontal" name="user_dauerauftrege" id="user_dauerauftrege_form" enctype="multipart/form-data" method="post" action="user_dauerauftrege_process_form.php">
	    ...
	    <div class="form-group col-md-3 setmyheight">
		  ...
		  <div class="form-group col-md-3 setmyheight">
                  ...
                  <option value="<?= print $_SESSION["u_userid"] ; ?>"><? print $_SESSION["name"] ; ?></option>
                  </select>		
                  </div>
              <div class="form-group col-md-3 setmyheight">
