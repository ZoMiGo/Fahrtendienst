    ...
    <div class="content">
        ...
        if (isset($_POST['db_server'], $_POST['db_name'], $_POST['db_user_name'], $_POST['db_user_password'], $_POST['db_prefix'])) {
            ...
            if ($connect) {
                ...
                if ($selectDB) {
                    ...
                    $createConfigFile = file_put_contents('../core/db_config.php', $replaceConfig);
                    if (!$createConfigFile) {
                        echo '<center><div class="form-group has-error">  <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> Can\'t Create Config File Set Permission to 777 </label></div></center>';
                    } else {
        ...
        <div class="box box-primary  lockscreen-wrapper" style="max-width: 800px ;margin: 0 auto; margin-top: 5%">
            <div class="box-header with-border">
                <center><h2 class="box-title info">Install Fahrtendinst Software</h2></center>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input class="form-control" type="text"
                                   ...
                                   name="db_prefix" id="db_prefix" placeholder="Prefix of tables Ex: vaz_">
                        </div>
                    </div>
                </div>
        ...
        <div class="box box-primary  lockscreen-wrapper" style="max-width: 800px ;margin: 0 auto; margin-top: 5%">
            <div class="box-header with-border">
                <center><h2 class="box-title info">Check File Permision</h2></center>
            </div>
...
if (is_writable($filename)) {
    echo 'Pleas Click Install Button to Start the Instalation';
} else {
    echo 'Pleas set Permision on core/db_config.php to 777';
}
?>
</div>
<!-- /.content-wrapper -->
